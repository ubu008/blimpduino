...
#define read_ch1 (PINB & (1 << 7))//Port B, pin 7 as channel 1;
#define read_ch2 (PINB & (1 << 6))//Port B, pin 6 as channel 2;
...
void pulse_servo(int angle)//Will convert the angle in the equivalent servo position... 
{
 ...
 OCR1B=(min16*16L*clockCyclesPerMicrosecond() + (max16-min16)*(16L*clockCyclesPerMicrosecond())*angle/180L)/8L;
