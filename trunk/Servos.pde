...
void pulse_servo(int angle)//Will convert the angle in the equivalent servo position... 
{
 ...
 OCR1B=((angle*(max16-min16))/180L+min16)*2L;// 2L is the sames only 2, but the L means LONG.. So the compiler will take as a LONG variable... you can also say "(long)2". 
}
     /**************************************************************
    * 
    ***************************************************************/
