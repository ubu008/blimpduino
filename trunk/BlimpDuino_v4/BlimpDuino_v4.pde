 ...
 *Add more comments
 *Added more definiting to change settings of the system without going so deeply into the source code.
...
//Is like the capacitor used to start moving big electric motors. ?
...
#define max16 2100 //max position in useconds
...
{ 
  ...
  case 0:
   ...
   else
   {
      ...
      test_servos(2000); //Module to test the vector servo
